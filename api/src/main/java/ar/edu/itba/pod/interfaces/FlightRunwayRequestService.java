...
public interface FlightRunwayRequestService extends Remote {
    ...
    void registerFlight(final String code, final String airline, final String destinationAirport, final FlightRunwayCategory minCategory) throws RemoteException, UniqueFlightCodeConstraintException, UnregistrableFlightException;
}
